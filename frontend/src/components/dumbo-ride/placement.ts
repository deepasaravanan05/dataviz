...
/**
 * WHERE THE DUMBO RIDE STANDS — a slot on the park ring.
 *
 * This ride used to search for its own ground. It was asked for a place behind the UFO Pendulum but off the line the Tea Cups
 * already held, and the placement fanned round from that bearing a few degrees
 * at a time until the ground was clear.
...
export const RIDE_CENTER: [number, number] = ringCenterOf("dumbo");
 ...
 *
 * The elephants fly on a circle, so this decides which way the boarding gap in
 * that circle faces.
 *
