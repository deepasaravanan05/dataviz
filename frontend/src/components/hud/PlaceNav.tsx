 ...
 */
export function PlaceNav({ showDashboardLink = true }: { showDashboardLink?: boolean } = {}) {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex max-w-[calc(100vw-2rem)] flex-wrap items-center justify-center gap-1 overflow-x-auto rounded-full border border-cyan-300/10 bg-[#070b14]/80 px-2 py-1.5 shadow-2xl shadow-black/40 backdrop-blur-xl">
        {/* The 2D dashboard is a page of its own, not a camera place. It is
            hidden where the dashboard is already embedded in the view. */}
        {showDashboardLink && (
          <>
            <a
              href="/dashboard"
